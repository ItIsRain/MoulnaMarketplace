...
// SECURITY: Do NOT trust the status query param from the redirect URL.
// The actual status update is handled by the POST webhook with HMAC verification.
// This GET handler only redirects the user back to the seller dashboard.
